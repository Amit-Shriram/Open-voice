...
# Evaluate the following candidate's response to the interview question provided. 

# Question: {question}
# Answer: {answer}

# If the answer provided by the candidate is irrelevant, inappropriate, off-topic  to the question, give a score based on your own judgement .
# Score the answer on a scale from 0 to 10, where 0 is the lowest score and 10 is the highest score. 
# Consider the following criteria in your evaluation: 

# 1. Relevance: How well does the answer addresses the question asked?
# 2. Clarity: Is the answer clearly articulated and easy to understand?
# 3. Completeness: Does the answer provide sufficient detail and cover all necessary aspects related to the question?

# In your response provide the integer score along with the resoning about on what basis did you gave this score.
...
# # answer = """ My name is Amit, I am from Solapur, I completed my B.tech in computer science and engineering also I have hands on in python and java language. """
# answer =  """ Avengers is good movie. """

# print(chain.invoke({"question": question, "answer": answer}))
