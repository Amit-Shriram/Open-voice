...
if "gif_state" not in st.session_state:
    st.session_state.gif_state = "silent"  # Initialize the GIF state to silent
...
# Display the current GIF based on the last state
display_gif(st.session_state.gif_state)
...
def generate_and_play_audio(text, speaker_wav, language="en", file_path="output.wav"):
    try:
        # Set GIF state to "asking" before generating and playing the audio
        st.session_state.gif_state = "asking"
        display_gif("asking")  # Update GIF to "asking"
...
def play_audio(file_path):
    # Play the audio while displaying the "asking" GIF
    ...
    # Set GIF state to "silent" after the audio finishes
    st.session_state.gif_state = "silent"
    display_gif("silent")  # Update GIF to "silent"
